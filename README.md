...
Completely free, forever. No attribution required.

---

### FEATURING...
* **FULLY RIGGED IK ARMATURE:** Ready for custom animations and poses.
* **2 SKIN COLORS:** Included variants for project flexibility.
* **1200 TRIANGLES:** Ultra-optimized for modern and retro-style engines.
* **512x512 TEXTURE SIZE:** Maintains that authentic, crunchy 90s feel.
* **MULTIPLE FORMATS:** Comes in **GLB**, **FBX**, and **OBJ**.

### PERFECT FOR...
* **Retro FPS / Boomer Shooters**
* **PS1 / PSX Style Projects**
* **Low Poly Horror & Prototyping**

---

### FIND ME HERE
* [**Twitter**](https://twitter.com/wriks)
* [**Website**](https://www.wriks.motorcycles)
* [**Patreon**](https://www.patreon.com/wriks)
* [**Ko-fi**](https://ko-fi.com/wriks)

### MY OTHER FREE ASSETS
* [**WRAD TEXTURES**](https://wriks.itch.io/wrad-textures) - A collection of retro-style textures to match these arms.
...
### LICENSE
This work is marked with **CC0 1.0 Universal**. You are free to copy, modify, and distribute these assets, even for commercial purposes, without asking permission or providing attribution.
